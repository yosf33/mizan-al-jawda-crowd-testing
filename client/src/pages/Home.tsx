    ...
    <main dir="rtl" className="min-h-screen overflow-hidden bg-[#f8f4e9] text-[#102a43]">
      ...
      <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-16 lg:grid-cols-[1.1fr_.9fr] lg:px-8 lg:pb-28 lg:pt-24">
        <div className="relative">
          <p className="eyebrow">منظومة عربية لاكتشاف العيوب قبل الإطلاق</p>
          <h1 className="mt-5 max-w-3xl text-5xl font-extrabold leading-[1.06] tracking-tight text-[#102a43] sm:text-6xl lg:text-7xl">الجودة ليست مصادفة.<span className="block text-[#b58225]">إنها هندسة ثقة.</span></h1>
          <p className="mt-7 max-w-2xl text-lg leading-8 text-[#53626d]">نربط فرق البرمجيات بمختبرين موثوقين لاكتشاف الأخطاء الوظيفية وتجارب الاستخدام الحرجة، ضمن دورة فرز ومكافآت شفافة.</p>
