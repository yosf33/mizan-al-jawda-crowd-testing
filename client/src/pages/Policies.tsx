...
const policies = [
  { id: "privacy", title: "الخصوصية", body: "نستخدم بيانات الحساب والتواصل فقط لتشغيل الحساب، تقديم الدعم، وحماية نزاهة المنصة. لا تصبح تفاصيل الهوية أو وسائل الدفع أو الأدلة مرئية للعامة." },
  { id: "terms", title: "شروط الاستخدام", body: "يجب أن تكون التقارير أصلية وقابلة لإعادة الإنتاج وضمن نطاق دورة اختبار مصرح بها. يظل قرار اعتماد التقرير والمكافأة خاضعاً لمسار الفرز والمراجعة المعروض في المنصة." },
  { id: "evidence", title: "سياسة الأدلة", body: "ترتبط الأدلة بتقرير محدد وتخزن بشكل خاص. يقتصر الوصول على المختبر المبلّغ، والعميل المرتبط بالدورة، والمشرفين المخولين وفق الصلاحيات المعتمدة." },
];
