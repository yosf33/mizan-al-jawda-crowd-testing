...
def main() -> int:
    ...
    try:
        ...
        if hasattr(error, "__cause__") and error.__cause__ is not None:
            print("Underlying cause:", error.__cause__, file=sys.stderr)
            if hasattr(error.__cause__, "stderr"):
                print("Subprocess stderr:", error.__cause__.stderr, file=sys.stderr)
            if hasattr(error.__cause__, "stdout"):
                print("Subprocess stdout:", error.__cause__.stdout, file=sys.stderr)
